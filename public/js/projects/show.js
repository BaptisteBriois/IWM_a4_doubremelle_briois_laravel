...
$("#categoryForm").submit(function (e) {
    ...
    $.ajax({
        ...
        $("#newCategory").before('<div id="col-category-' + response.category.id + '" class="col-category">' + '<div class="panel-category panel panel-default">' + '<div class="panel-heading">' + response.category.title + '' + '</div>' + '<div class="panel-drag panel-body categoryTasks"></div>' + '<div class="panel-footer">' + '<form class="taskForm" data-category-id="' + response.category.id + '">' + '<div class="form-group">' + '<input type="text" class="form-control" placeholder="Titre" name="title">' + '</div>' + '</form>' + '</div>' + '</div>' + '</div>');
    });
});
